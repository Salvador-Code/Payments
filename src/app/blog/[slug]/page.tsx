...
> = {
  "why-we-built-nppn": {
    title: "Why We Built NPPN: A Letter from the Founders",
  ...
  "payments-career-guide-2026": {
    ...
    content: [
      ...
      "That\u2019s exactly what NPPN\u2019s Student & Early-Career branch is designed to provide. You\u2019ll get access to practitioners, content, and events that help you build the knowledge and connections you need to land your first payments role.",
    ],
  },
            ...
            <div className="mt-12 pt-8 border-t border-ice-dark">
              <div className="bg-ice rounded-2xl p-8 text-center">
                ...
                <p className="text-sm text-slate mb-6">
                  NPPN members get access to in-depth discussions, closed-door
