          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              <input
                ...
                className="w-full sm:w-72 min-w-0 bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-teal/50 transition-colors"
              />
              <button className="inline-flex items-center justify-center gap-2 bg-teal text-white text-sm font-semibold px-5 py-2.5 rounded-lg hover:bg-teal-light transition-colors shrink-0 w-full sm:w-auto">
      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
        ...
        <div className="mt-14 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/25">
            &copy; {new Date().getFullYear()} NEFTI. All
            rights reserved.
          </p>
          <p className="text-xs text-white/25">
